...
import { Check, ChevronLeft, CheckCircle, X, MessageCircle } from 'lucide-react';
...
const ImageSlider: React.FC<{ images: string[] }> = ({ images }) => {
  ...
  if (!images || images.length === 0) return <div className="slider-placeholder" />;
            ...
            {prices.map((plan, idx) => (
              ...
              >
                ...
                <div className="card-body">
                  <h3 className="service-name">{plan.serviceName}</h3>
                  ...
                  <ul className="features-list">
                    ...
                    {plan.features.length > 4 && <li className="more-features">+{plan.features.length - 4} more features</li>}
                  </ul>

                  <div className="card-zoom-indicator" style={{ textAlign: 'center', marginTop: 'auto', fontSize: '0.8rem', color: 'var(--accent-color)', fontWeight: 600 }}>
              ...
              <div className="modal-layout">
                <div className="modal-image-area">
                   <div className="modal-slider-wrapper">
                      <ImageSlider images={selectedPlan.images} />
                   </div>
                </div>
                <div className="modal-details-area">
                  <div className="modal-badge">Service Plan</div>
                  <h2>{selectedPlan.serviceName}</h2>
                  <div className="modal-price-big">₹{selectedPlan.price}</div>
